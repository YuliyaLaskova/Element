...
internal class Asset: NSObject {
  ...
  @objc(AssetImages) internal class Images: NSObject {
    ...
    internal static let greenMatrixCodeWallpaper = ImageAsset(name: "green_matrix_code_wallpaper")
    internal static let launchScreenLogo = ImageAsset(name: "launch_screen_logo")
    internal static let logoCvaTechnologies = ImageAsset(name: "logo_cva_technologies")
  }
  @objcMembers
