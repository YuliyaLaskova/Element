...
public class ElementView: UIView {
    ...
    private func createPath() {
        ...
        path.shapeLayer.fillColor = UIColor(.blue).cgColor
    ...
    private func createPath1() {
        ...
        path_1.shapeLayer.fillColor = UIColor(.blue).cgColor
    ...
    private func createPath2() {
        ...
        path_2.shapeLayer.fillColor = UIColor(.blue).cgColor
    ...
    private func createPath3() {
        ...
        path_3.shapeLayer.fillColor = UIColor(.blue).cgColor
